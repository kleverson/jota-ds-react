...
const css = createGooberGetter(TagSelectStyleType);
...
export default css`
  &.${namespace}-TagSelect {
    ...
    &--onColor {
      ...
      &:hover {
        border: ${({ onColor }) => onColor.hover.backgroundColor} ${context => context.borderWidth}
          solid;
      ...
      &:focus-visible:not(:active) {
        border-radius: ${context => context.borderRadius};
        border: ${({ onColor }) => onColor.focus.backgroundColor} ${context => context.borderWidth}
          solid;
      ...
      &:active {
        border: ${({ onColor }) => onColor.active.backgroundColor} ${context => context.borderWidth}
          solid;
      ...
      &--disabled {
        ...
        background-color: ${({ onColor }) =>
          hexToRGB(onColor.disabled.backgroundColor, onColor.disabled.opacity)};
